...
import {containers, advancedFields, basicFields, customFields,associatedFields} from "@/components/form-designer/widget-panel/widgetsConfig.js"
...
export function createDesigner(vueInstance) {
  ...
  return {
    ...
    getContainerByType(typeName) {
      let allWidgets = [...containers, ...basicFields, ...advancedFields, ...customFields,...associatedFields]
      let foundCon = null
