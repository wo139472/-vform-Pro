  ...
  <el-scrollbar class="side-scroll-bar">
    ...
    <el-tabs v-model="firstTab" class="no-bottom-margin indent-left-margin">
      ...
      <el-collapse v-model="activeNames" class="widget-collapse">
        ...
        <el-collapse-item name="1" :title="i18nt('designer.basicFieldTitle')">
        ...
        <el-collapse-item name="2" :title="i18nt('designer.advancedFieldTitle')">
        ...
        <el-collapse-item name="3" :title="i18nt('designer.containerTitle')">
        ...
        <el-collapse-item name="5" :title="i18nt('designer.associatedFieldTitle')">
          <draggable tag="ul" :list="associatedFields" :group="{name: 'dragGroup', pull: 'clone', put: false}"
                     :move="checkFieldMove"
                     :clone="handleFieldWidgetClone" ghost-class="ghost" :sort="false">
            <li v-for="(fld, index) in associatedFields" :key="index" class="field-widget-item" :title="fld.displayName"
                @dblclick="addFieldByDbClick(fld)">
              <span><svg-icon :icon-class="fld.icon" class-name="color-svg-icon" />{{getWidgetLabel(fld)}}</span>
            </li>
          </draggable>
        ...
        <template v-for="(ft, idx) in formTemplates">
          <el-card :key="idx" :bord-style="{ padding: '0' }" shadow="hover" class="ft-card">
            ...
            <div class="bottom clear-fix">
              ...
              <el-button type="text" class="right-button" @click="loadFormTemplate(ft.jsonUrl, ft.jsonStr)">
...
<script>
  ...
  import {containers, basicFields, advancedFields, customFields,associatedFields} from "./widgetsConfig"
